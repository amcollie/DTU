CREATE DEFINER=`h5g8w9v3_DEVADM`@`%` PROCEDURE `INSERT_PROFILE_FIVE_PASSENGER`(
...
IN input5_passport_id varchar(75), 

IN input5_number_of_visits int(11), 
IN input5_mobile varchar(15), 
IN input5_home_phone varchar(15), 
IN input5_work_phone varchar(15), 
IN input5_email_address varchar(145), 
IN input5_first_name varchar(75), 
IN input5_middle_name varchar(75),
IN input5_last_name varchar(75), 
IN input5_gender varchar(6),
IN input5_country_of_birth varchar(80),
IN input5_nationality varchar(80),
IN input5_date_of_birth date,
IN input5_document_type varchar(25), 
IN input5_immigration_status varchar(45),
IN input5_expiration_date date,
IN input5_photo_upload text, 
IN input5_passport_upload text
...
(passport_id, country, address, address_cont, city_town, state_province, zip_postal_code)
VALUES
(input5_passport_id, share_country, share_address, share_address_cont, share_city_town, 
share_state_province, share_zip_postal_code);
...
date_of_departure)
VALUES
(input5_number_of_visits, input4_passport_id, share_arrival_port, share_mode_of_travel, 
share_country_of_embarcation, share_port_of_embarcation, share_airline_name, share_flight_number,
share_vessel_name, share_vessel_number, share_date_of_arrival, share_date_of_departure);
...
emergency_contact_lastname, emergency_contact_relationship, emergency_contact_phone)
VALUES
(input4_passport_id, input4_mobile, input4_home_phone, input4_work_phone, input4_email_address, share_emergency_contact_firstname, 
share_emergency_contact_lastname, share_emergency_contact_relationship, share_emergency_contact_phone);
...
emergency_contact_lastname, emergency_contact_relationship, emergency_contact_phone)
VALUES
(input5_passport_id, input5_mobile, input5_home_phone, input5_work_phone, input5_email_address, share_emergency_contact_firstname, 
share_emergency_contact_lastname, share_emergency_contact_relationship, share_emergency_contact_phone);
...
input4_nationality, share_passport_id);

INSERT INTO PASSENGER_INFORMATION
(first_name, middle_name, last_name, gender, date_of_birth, country_of_birth, nationality, passport_reg_id)
VALUES
(input5_first_name, input5_middle_name, input5_last_name, input5_gender, input5_date_of_birth, input5_country_of_birth,
input5_nationality, share_passport_id);
...
(passport_id, document_type, immigration_status, expiration_date)
VALUES
(input4_passport_id, input4_document_type, input4_immigration_status, input4_expiration_date);

INSERT INTO PASSENGER_TRAVEL_DOCUMENTS
(passport_id, document_type, immigration_status, expiration_date)
VALUES
(input5_passport_id, input5_document_type, input5_immigration_status, input5_expiration_date);
...
(passport_reg_id, passport_id, passenger_reg_amount)
VALUES
(share_passport_id, input4_passport_id, share_passenger_reg_amount);

INSERT INTO REGISTRATION_ID_LINKS
(passport_reg_id, passport_id, passenger_reg_amount)
VALUES
(share_passport_id, input5_passport_id, share_passenger_reg_amount);
...
(photo_upload, passport_upload, passport_id)
VALUES
(input4_photo_upload, input4_passport_upload, input4_passport_id);

INSERT INTO TRAVEL_DOCUMENTS_UPLOAD
(photo_upload, passport_upload, passport_id)
VALUES
(input5_photo_upload, input5_passport_upload, input5_passport_id);
END