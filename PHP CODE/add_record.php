...
if($_POST)
{
    ...
    $input_type_of_accommodation = $_POST ['input_type_of_accommodation'];
    ...
    $query = "CALL INSERT_PROFILE_PASSENGER(
        '$input_passenger_reg_amount',
        '$input_passenger_record_id',

        '{$conn->real_escape_string($input_country)}',
        '{$conn->real_escape_string($input_address)}',
        '{$conn->real_escape_string($input_address_cont)}',
        '$input_city_town',
        '$input_state_province',
        '$input_zip_postal_code',

        '$input_number_of_visits',
        '{$conn->real_escape_string($input_arrival_port)}',
        '$input_mode_of_travel',
        '{$conn->real_escape_string($input_country_of_embarcation)}',
        '{$conn->real_escape_string($input_port_of_embarcation)}',
        '$input_airline_name',
        '$input_flight_number',
        '$input_vessel_name',
        '$input_vessel_number',
        ...
        '{$conn->real_escape_string($input_emergency_contact_firstname)}',
        '{$conn->real_escape_string($input_emergency_contact_lastname)}',
        '$input_emergency_contact_relationship',
        '$input_emergency_contact_phone',

        '$input_trip_purpose',
        '$input_type_of_accommodation',
        '$input_hotel_name',
        '$input_local_city',
        '$input_local_address',
        '$input_sponsor_name',
        ...
        '$input_work_phone',
        '$input_email_address',
        '{$conn->real_escape_string($input_first_name)}',
        '{$conn->real_escape_string($input_middle_name)}',
        '{$conn->real_escape_string($input_last_name)}',
        '$input_gender',
        ...
        '{$conn->real_escape_string($input2_first_name)}',
        '{$conn->real_escape_string($input2_middle_name)}',
        '{$conn->real_escape_string($input2_last_name)}',
        '$input2_gender',
        ...
        '{$conn->real_escape_string($input3_first_name)}',
        '{$conn->real_escape_string($input3_middle_name)}',
        '{$conn->real_escape_string($input3_last_name)}',
        '$input3_gender',
        ...
        '{$conn->real_escape_string($input4_first_name)}',
        '{$conn->real_escape_string($input4_middle_name)}'
        '{$conn->real_escape_string($input4_last_name)}',
        '$input4_gender',
    ...
    if ($conn->query($query)) {
        ...
        echo "CALL failed : (Code: {$conn->errno}) \n {$conn->error}";
    }
