...
$input2_number_of_visits = $_POST ['number_of_visits'];
...
$input3_home_phone  = $_POST ['input3_home_phone'];
$input3_work_phone  = $_POST ['input3_work_phone'];
...
$input3_photo_upload    = $_POST ['input3_photo_upload'];
...
$input4_home_phone  = $_POST ['input4_home_phone'];
$input4_work_phone  = $_POST ['input4_work_phone']; 
...
$input4_photo_upload    = $_POST ['input4_photo_upload'];
$input4_passport_upload     = $_POST ['input4_passport_upload'];

    // Stored procedure code
        
if(!$mysqli->query("CALL INSERT_PROFILE_PASSENGER('$input_passenger_reg_amount',
'$input_passenger_record_id','$input_country,'$input_address','$input_address_cont',
'$input_city_town','$input_state_province','$input_zip_postal_code','$input_number_of_visits',
'$input_arrival_port','$input_mode_of_travel','$input_country_of_embarcation','$input_port_of_embarcation', 
'$input_airline_name','$input_flight_number', '$input_vessel_name','$input_vessel_number',
'$input_date_of_arrival','$input_date_of_departure,'$input_mobile','$input_home_phone',
'$input_work_phone','$input_email_address','$input_emergency_contact_firstname','$input_emergency_contact_lastname,'
'$input_emergency_contact_relationship','$input_emergency_contact_phone' 
